...
# assert os.path.exists(_system_config.max_maxbatch_bin)
...
# #make change so that if temp doesnt exist create one.
# import logging
...
#         logging.error(f"Error occurred while copying {obj_settings_file} to {obj_settings_backup_file}: {e}")
#         raise
# # if shutil.coopy doesnt work properly.
# else:
...
# #make condition for obj_settings_file and sth similar.
...
# #yesari shutil bata ni overwrite garna milcha re
# import shutil

# # Ensure the output directory exists
# os.makedirs(out_max_sceneassets_photometric_dir, exist_ok=True)

# # Copy the directory with overwriting enabled
# shutil.copytree(in_max_sceneassets_photometric_dir, out_max_sceneassets_photometric_dir, dirs_exist_ok=True)
...
# try:
#     retval = subprocess.run(shlex.split(cmd))
#     retval.check_returncode()
# except subprocess.CalledProcessError as e:
#     print(f"Error during the dataset export: {e}")
